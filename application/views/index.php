<!-- Page Header -->
<div class="page-header text-center py-3 animate__animated animate__fadeIn mt-3">
...
<div class="card animate__animated animate__fadeIn animate__delay-1s mb-4">
    <div class="card-body">
        ...
        <div class="alert alert-info mb-4 d-flex align-items-center">
          ...
          <div>
            <strong>Informasi:</strong> Silakan input data mahasiswa dengan lengkap dan benar. Data akan disimpan dalam database kampus.
          </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="form-section animate__animated animate__fadeInLeft">
                    <h5 class="text-center mb-4"><i class="bi bi-person-plus-fill me-2"></i>Input Data Mahasiswa</h5> 

                    <form action="<?php echo site_url('mahasiswa/simpan_data'); ?>" method="post" enctype="multipart/form-data">
                      <div class="mb-3">
                ...
                <table class="table table-hover table-dark">
                  ...
                  <tbody>
                    ...
                    <tr class="text-center align-middle fade-in table-dark">
                      ...
                      <td>
                        <span class="text-center align-middle badge <?php echo $badge_color; ?> badge-jurusan">
